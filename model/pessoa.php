...
require_once $_SERVER['DOCUMENT_ROOT'] . '/exemplo-banco-de-dados/controller/conexao.php';
...
class Pessoa
{
    ...
    public function buscarporid($id)
    {
        ...
        //mostra todas as informações de pessoa
        $stmt = $this->conexao->getConexao()->prepare($sql);
        //pega a conecxão da classe Conecxão e prepara o comando sql
        $stmt->bind_param('i', $id);
        //busca o id
        $stmt->execute();
        //executa os comandos
        $result = $stmt->get_result();
        //recebe os resultados dos comandos
    ...
    public function atualizar($id)
    {
        ...
        //da o comando update na tabela
        $stmt = $this->conexao->getConexao()->prepare($sql);
        //prepara o comando sql pegando conecxão
    ...
    public function excluir($id)
    {
        ...
        $stmt->bind_param('i', $id);
        return $stmt->execute();
        /*este bloco é semelhante ao anterior entretanto ao invés de atualizar cada campo
        ele apenas exclui todo registro com um certo id que é passado como parâmetro*/
    }
}
